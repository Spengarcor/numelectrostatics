        ...
        for(int i = 0; i != rows; ++i){ 
			...
			* ( x_before + x_after + alpha*(y_before + y_after) );
			...
			hy_after = 1;
		      ...
		      mesh[i][j] = x_after * hx_before * hy_before * hy_after /
			(hx_after*hx_before + hy_after*hy_before) /
			(hx_after + hx_before) +
			x_before * hx_after * hy_before * hy_after /
			(hx_after*hx_before + hy_after*hy_before) /
			(hx_after + hx_before) +
			y_after * hy_before * hx_after * hx_before /
			(hx_after*hx_before + hy_after*hy_before) /
			(hy_after+hy_before) +
			y_before * hy_after * hx_after * hx_before /
			(hx_after*hx_before + hy_after*hy_before) /
			(hy_after+hy_before);
		    }
