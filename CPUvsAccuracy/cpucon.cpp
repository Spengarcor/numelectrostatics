...
void Save::SaveCPUdata(const std::vector<CPUdata> & snapshot1, const std::vector<CPUdata> & snapshot2, const double a) {
	...
	for (size_t i=0; i < Num_of_Entries; i++) {	
		...
		file << a << ", " << CPUConsumption << ", " << TOTAL_TIME << ", " << ACTIVE_TIME << ", " << IDLE_TIME << std::endl;
